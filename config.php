<?php
	...
	define('APP_ID',"9438e26bd05e080c997af2a772926786");
	...
	define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['nom'] : null ));
	...
	define('USER_ROLE',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['type'] : null ));
