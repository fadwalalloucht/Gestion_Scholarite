                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'admins/edit/' + data.id" method="post">
    ...
    <script>
	var AdminsEditComponent = Vue.component('adminsEdit', {
		template : '#adminsEdit',
		...
		data: function() {
			return {
				data : { id_user: '',created_at: '',update_at: '',deleted_at: '', },
			}
		},
		computed: {
			pageTitle: function(){
