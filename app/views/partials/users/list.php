                            ...
                            <div  class=" animated fadeIn">
                                <div class="">
                                        ...
                                        <table class="table" :class="tablestyle">
                                            ...
                                            <tbody>
                                                <tr v-for="(data,index) in records">
                                                    ...
                                                    <td><router-link :to="'/users/view/' +  data.id_user">{{data.id_user}}</router-link></td>
                                                    <td> {{ data.nom }} </td>
                                                    <td> {{ data.Prenom }} </td>
                                                    <td> {{ data.email }} </td>
                                                    ...
                                                    <th class="td-btn">
                                                        <div >
                                                            <router-link v-if="viewbutton" class="btn btn-sm btn-outline-primary" title="View Record" :to="'/users/view/' + data.id_user">
                                                            <i class="fa fa-eye"></i> Vue
                                                            </router-link>
                                                            <router-link v-if="editbutton" class="btn btn-sm btn-outline-success" title="Edit This Record" :to="'/users/edit/' + data.id_user">
                                    ...
                                    <div v-if="showfooter" class="page-footer">
                                        ...
                                        <dataimport extensions="" buttontext="Importer des données" post-action="users/import_data" v-if="importbutton"></dataimport>
                                    </div>
                                </div>
                            </div>
                        </div>
