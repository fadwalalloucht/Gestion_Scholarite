                ...
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Vue Users</h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div  class=" animated fadeIn">
                                <div class="profile-bg mb-2">
                                    ...
                                    <div v-if="editbutton || deletebutton || exportbutton" class="mt-2">
                                        <span >
                                            <router-link class="btn btn-sm btn-info has-tooltip" v-if="editbutton"  :to="'/users/edit/'  + data.id_user">
                                            <i class="fa fa-edit"></i> Modifier
                                            </router-link>
                                            <button @click="deleteRecord" class="btn btn-sm btn-danger" v-if="deletebutton" :to="'/users/delete/' + data.id_user">
	...
	var UsersViewComponent = Vue.component('usersView', {
		...
		data: function() {
			return {
				data : {
					default :{
						id_user: '',nom: '',Prenom: '',email: '',telephone: '',type: '',lieu_naissance: '',date_naissance: '',genre: '',cin: '',adresse: '',
					},
				},
			}
		},
