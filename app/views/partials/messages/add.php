                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="messages/add" method="post">
    ...
    <script>
	var MessagesAddComponent = Vue.component('messagesAdd', {
		template : '#messagesAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
		...
		data : function() {
			return {
				...
				data : {
					libelle_message: '',emmeteur: '',recepteur: '',created_at: '',update_at: '',deleted_at: '',
				},
			}
		},
		computed: {
		...
		methods: {
			...
			resetForm : function(){
				this.data = {libelle_message: '',emmeteur: '',recepteur: '',created_at: '',update_at: '',deleted_at: '',};
