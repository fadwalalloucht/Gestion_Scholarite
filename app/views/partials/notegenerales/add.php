                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="notegenerales/add" method="post">
    ...
    <script>
	var NotegeneralesAddComponent = Vue.component('notegeneralesAdd', {
		template : '#notegeneralesAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
			...
			routename : {
				type : String,
				default : 'notegeneralesadd',
			},
			apipath : {
				type : String,
				default : 'notegenerales/add',
			},
		},
		data : function() {
			return {
