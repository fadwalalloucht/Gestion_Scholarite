    <template id="administrationsEdit">
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'administrations/edit/' + data.id" method="post">
    ...
    <script>
	var AdministrationsEditComponent = Vue.component('administrationsEdit', {
		template : '#administrationsEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'administrationsedit',
			},
			apipath : {
				type : String,
				default : 'administrations/edit',
			},
		},
		data: function() {
			return {
				data : { logo: '',nom_ecole: '',address: '',capital: '',ville: '',code_postal: '',telephone: '',created_at: '',update_at: '',cnss: '',ice: '',num_patente: '',site_web: '',email: '',rs: '', },
			}
		},
		computed: {
			pageTitle: function(){
