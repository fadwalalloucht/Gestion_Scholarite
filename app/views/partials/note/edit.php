                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'note/edit/' + data.id" method="post">
    ...
    <script>
	var NoteEditComponent = Vue.component('noteEdit', {
		template : '#noteEdit',
