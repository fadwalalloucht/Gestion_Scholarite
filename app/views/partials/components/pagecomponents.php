	...
	<div>
		<div class="row">
			<div v-if="showRecordCount" class="col align-self-center">
				<label> Records  : {{recordPosition}}  sur  {{totalItems}}</label>
			</div>
			...
			<div v-if="showPageLimit" class="col align-self-center">
				<label>Limite  : <input @change="limitChanged" v-model="pageLimit" type="number" step="1" min="0" :max="totalPages" class="form-control form-control-sm" style="display:inline-block;width:50px" /> </label>
			</div>
