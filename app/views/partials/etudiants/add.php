                ...
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-md-6 comp-grid" :class="setGridSize">
                            <niceformwizard shape="tab" color="royalblue" step-size="md">
                                <template slot="header">
                                    <div class="text-left">
                                        <h4>Ajouter Etudiant</h4>
                                        <p class="text-muted">Entrer les information d'etudiant</p>
                                    </div>
                                </template>
                                <tab-content icon=" " title="Information d'etudiant">
                                    <div class="">
                                        <div class="text-center">
                                            <div class=" animated fadeIn">
                                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="etudiants/add" method="post">
                                            ...
                                            <wizardbtn icon='<i class="fa fa-chevron-right"></i>' text="Etape Suivante"></wizardbtn>
                                        </div>
                                    </div>
                                </tab-content>
                                <tab-content icon=" " title="Les information de tuteur">
                                    <div class="">
                                        <div class="text-center">
                                            <div class=" animated fadeIn">
                                ...
                                <tab-content icon=" " title="Filliere">
    ...
    <script>
        var EtudiantsAddComponent = Vue.component('etudiantsAdd', {
            template: '#etudiantsAdd',
            mixins: [AddPageMixin],
            props: {
                page: {
                    type: String,
                ...
                routename: {
                    type: String,
                    default: 'etudiantsadd',
                },
                apipath: {
                    type: String,
                    default: 'etudiants/add',
                },
            },
            data: function() {
                return {
