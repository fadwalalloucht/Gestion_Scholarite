                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'absences/edit/' + data.id" method="post">
    ...
    <script>
	var AbsencesEditComponent = Vue.component('absencesEdit', {
		template : '#absencesEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'absencesedit',
			},
			apipath : {
				type : String,
				default : 'absences/edit',
			},
		},
		data: function() {
			return {
				data : { justifie: '',id_seance: '',id_etudiant: '',created_at: '',update_at: '',deleted_at: '', },
			}
		},
		computed: {
			pageTitle: function(){
