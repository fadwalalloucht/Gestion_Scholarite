                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'salles/edit/' + data.id" method="post">
    ...
    <script>
	var SallesEditComponent = Vue.component('sallesEdit', {
		template : '#sallesEdit',
		...
		data: function() {
			return {
				data : { libelle: '',created_at: '',update_at: '',deleted_at: '', },
			}
		},
		computed: {
			pageTitle: function(){
