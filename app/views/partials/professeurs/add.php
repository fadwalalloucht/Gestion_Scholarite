                    ...
                    <div class="row ">
                        <div class="col-md-7 comp-grid" :class="setGridSize">
                            <div class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="professeurs/add" method="post">
    ...
    <script>
        var ProfesseursAddComponent = Vue.component('professeursAdd', {
            template: '#professeursAdd',
            mixins: [AddPageMixin],
            props: {
                pagename: {
                    type: String,
                ...
                routename: {
                    type: String,
                    default: 'professeursadd',
                },
                apipath: {
                    type: String,
                    default: 'professeurs/add',
                },
            },
            data: function() {
                return {
