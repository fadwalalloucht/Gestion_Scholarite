	...
	<body>
		<div id="page-actionbar">
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<button class="btn btn-danger btn-sm" onclick="printPage()"><img src="<?php print_link("assets/js/export-plugin/images/print.svg") ?>" /> Imprimer | PDF <img src="<?php print_link("assets/js/export-plugin/images/pdf.svg") ?>" /></button>
					<button   class="btn btn-warning  btn-sm" onclick="exportPng()"> Enregistrer PNG <img src="<?php print_link("assets/js/export-plugin/images/png.svg") ?>" /> </button>
					<button  class="btn btn-success  btn-sm" onclick="exportCsv()"> Exporter en CSV <img src="<?php print_link("assets/js/export-plugin/images/csv.svg") ?>" /> </button>
					<button  class="btn btn-info  btn-sm" onclick="exportExcel()"> Exporter en Excel <img src="<?php print_link("assets/js/export-plugin/images/xls.svg") ?>" /> </button>
					<button  class="btn btn-primary  btn-sm" onclick="exportWord()"> Exporter en Excel <img src="<?php print_link("assets/js/export-plugin/images/doc.svg") ?>" /> </button>
				</div>
			</div>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-2 d-print-none">	
					<div class="card my-4">
						<div class="card-header">Imprimer les paramètres de page</div>
						<div class="card-body">
							...
							<div class="form-group">
								<label class="btn btn-primary btn-block"><input onclick="toggleCompanyHeader()" checked="checked" type="checkbox" /> Afficher en-tête</label>
							</div>
							<div class="form-group">
								<button onclick="removePageLinks()" class="btn btn-warning btn-block "> Supprimer les liens de page</button>
							</div>
							
							<div class="page-title">Champs de la page d'exportation</div>
